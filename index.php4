...
<body>
    <center>
<img src="/talepsitesi/logo/artalogo.jpg" 
alt="Arta logosu bulunamadı!" width="400"
height="250" />
    </center>
    ...
    <select name="selection" required>
        ...
        <option value="Talepte bulunmak istiyorum">Talepte bulunmak istiyorum</option>
                            ...
                            <div class="button-area">
                                ...
                                <button 
                                onclick="closeWindow()">İletişime Geç</button>
...
<div id="timer">00:00:00</div>
    ...
    echo "<p></p>";
    header("refresh:90;url=logout.php");
    ?>
    
    <p><span style="color:#DCDCDC;">Bu sayfa 90 saniye sonra kapanacak.</p>
